...
const { validateId, validateItem, validateOffer } = require('../middlewares/validator');
...
router.post('/', isLoggedIn, validateItem, upload.single('image'), itemController.create);
router.get('/:id', validateId, itemController.show);
router.get('/:id/edit', validateId, isLoggedIn, isSeller, itemController.edit);
router.put('/:id', validateId, isLoggedIn, isSeller, validateItem, itemController.update);
router.delete('/:id', validateId, isSeller, isLoggedIn, itemController.delete);

//offer routes
router.post('/:id/offer', validateId, isLoggedIn, isNotSeller, isActive, validateOffer, offerController.create);
